...
export const SKILL_TREE: SkillNode[] = [
  ...
  // ---- Ranger base: three new pre-path skills ----
  {
    id: "rng_woundshot", charClass: "ranger", name: "Wounding Shot",
    description: "A barbed arrow lodges deep — each strike you land for the next two turns hits harder while the wound is fresh.",
    kind: "active_attack",
    maxRank: 4,
    rankCosts: [1, 2, 2, 3],
    baseManaCost: 10, manaCostPerRank: 2,
    ...
    effect: {
      kind: "damage",
      baseMagnitude: 1.6, magnitudePerRank: 0.25,
      scaling: { stat: "agi", basePct: 160, pctPerRank: 30 },
    },
    requires: ["rng_pierce"],
    position: { tier: 2, col: 2 },
    flavor: "The worst wounds are the ones the body remembers.",
  },
  {
    id: "rng_camouflage", charClass: "ranger", name: "Camouflage",
    description: "Melt into the terrain. A heavy shield absorbs the next blow while you vanish from your enemy's sight.",
    kind: "active_buff",
    maxRank: 3,
    rankCosts: [2, 2, 3],
    baseManaCost: 16, manaCostPerRank: 3,
    cooldown: 4,
    effect: {
      kind: "shield",
      baseMagnitude: 70, magnitudePerRank: 30,
      duration: 99,
    },
    requires: ["rng_evade"],
    position: { tier: 3, col: 2 },
    flavor: "The forest does not announce itself.",
  },
  {
    id: "rng_survivalist", charClass: "ranger", name: "Survivalist",
    description: "Field medicine from the school of hard knocks — stitch yourself up for a moderate heal.",
    kind: "active_heal",
    maxRank: 3,
    rankCosts: [2, 2, 3],
    baseManaCost: 18, manaCostPerRank: 3,
    cooldown: 3,
    effect: {
      kind: "heal",
      baseMagnitude: 0.18, magnitudePerRank: 0.06,
    },
    requires: ["rng_focus"],
    position: { tier: 2, col: 3 },
    flavor: "You learned to bleed efficiently a long time ago.",
  },
  ...
  // ---- Sorcerer base: three new pre-path skills ----
  {
    id: "sor_frost_lance", charClass: "sorcerer", name: "Frost Lance",
    description: "A needle of concentrated cold punches through armor and chills whatever it finds behind it.",
    kind: "active_attack",
    maxRank: 4,
    rankCosts: [1, 2, 2, 3],
    baseManaCost: 10, manaCostPerRank: 2,
    ...
    effect: {
      kind: "damage",
      baseMagnitude: 1.8, magnitudePerRank: 0.25,
      scaling: { stat: "int", basePct: 180, pctPerRank: 30 },
    },
    requires: ["sor_bolt"],
    position: { tier: 2, col: 2 },
    flavor: "Cold is patient in ways fire can never be.",
  },
  {
    id: "sor_arcane_ward", charClass: "sorcerer", name: "Arcane Ward",
    description: "Weave mana into a protective lattice that intercepts the next blow before it reaches flesh.",
    kind: "active_buff",
    maxRank: 3,
    rankCosts: [2, 2, 3],
    baseManaCost: 16, manaCostPerRank: 3,
    ...
    effect: {
      kind: "shield",
      baseMagnitude: 60, magnitudePerRank: 30,
      duration: 99,
    },
    requires: ["sor_mend"],
    position: { tier: 2, col: 3 },
    flavor: "Magic that saves you is still magic.",
  },
  {
    id: "sor_mind_surge", charClass: "sorcerer", name: "Mind Surge",
    description: "Push your intellect past its limits. A fierce INT spike for three turns — spells cast during this window hit catastrophically hard.",
    kind: "active_buff",
    maxRank: 3,
    rankCosts: [2, 3, 3],
    baseManaCost: 14, manaCostPerRank: 2,
    ...
    effect: {
      kind: "buff_stat",
      baseMagnitude: 16, magnitudePerRank: 8,
      duration: 3,
      buffKind: "buff_int",
    },
    requires: ["sor_starfall"],
    position: { tier: 3, col: 2 },
    flavor: "The mind that breaks its own ceiling comes back taller.",
  },

  // ===================== RANGER — SHARPSHOOTER PATH =====================
  // Precision, burst, glass-cannon. Pairs with crit / power / AGI gear.
  // Pays HP for devastating shots; every kill is either clean or costly.
  {
    id: "ss_aimed_shot", charClass: "ranger", path: "sharpshooter",
    name: "Aimed Shot",
    description: "Draw. Breathe. Release. A single arrow launched with total intention — it hits harder than anything in your base kit.",
    kind: "active_attack",
    maxRank: 5,
    rankCosts: [2, 2, 3, 3, 4],
    baseManaCost: 12, manaCostPerRank: 2,
    ...
    effect: {
      kind: "damage",
      baseMagnitude: 2.0, magnitudePerRank: 0.35,
      scaling: { stat: "agi", basePct: 200, pctPerRank: 35 },
    },
    requires: [],
    position: { tier: 1, col: 1 },
    minLevel: 15,
    levelRequirementPerRank: [15, 17, 19, 21, 23],
    flavor: "The arrow knows the way. You just let go.",
  },
  {
    id: "ss_eagles_eye", charClass: "ranger", path: "sharpshooter",
    name: "Eagle's Eye",
    description: "Your perception sharpens to a razor edge — every muscle reflex becomes instinct. Grants a surge of Agility for 3 turns.",
    kind: "active_buff",
    maxRank: 3,
    rankCosts: [2, 2, 3],
    baseManaCost: 10, manaCostPerRank: 2,
    ...
    effect: {
      kind: "buff_stat",
      baseMagnitude: 20, magnitudePerRank: 10,
      duration: 3,
      buffKind: "buff_agi",
    },
    requires: [],
    position: { tier: 1, col: 2 },
    minLevel: 15,
    levelRequirementPerRank: [15, 18, 21],
    flavor: "The hawk does not rush. It is simply never wrong.",
  },
  {
    id: "ss_triple_shot", charClass: "ranger", path: "sharpshooter",
    name: "Triple Shot",
    description: "Three arrows, one breath. Not as precise as Aimed Shot, but the sheer volume of steel makes up the difference.",
    kind: "active_attack",
    maxRank: 4,
    rankCosts: [2, 3, 3, 4],
    baseManaCost: 18, manaCostPerRank: 3,
    ...
    effect: {
      kind: "damage",
      baseMagnitude: 1.8, magnitudePerRank: 0.3,
      scaling: { stat: "agi", basePct: 180, pctPerRank: 30 },
    },
    requires: ["ss_aimed_shot"],
    position: { tier: 2, col: 1 },
    minLevel: 18,
    levelRequirementPerRank: [18, 20, 22, 24],
    flavor: "Three chances to be right.",
  },
  {
    id: "ss_predator", charClass: "ranger", path: "sharpshooter",
    name: "Predator's Mark",
    description: "You cut yourself opening the shot — a blood-rite that channels pain into precision. Costs 12 HP but deals catastrophic damage.",
    kind: "active_attack",
    maxRank: 4,
    rankCosts: [3, 3, 4, 4],
    baseManaCost: 20, manaCostPerRank: 3,
    cooldown: 3,
    effect: {
      kind: "damage",
      baseMagnitude: 2.8, magnitudePerRank: 0.4,
      scaling: { stat: "agi", basePct: 280, pctPerRank: 45 },
      selfDamage: 12,
    },
    requires: ["ss_eagles_eye"],
    position: { tier: 2, col: 2 },
    minLevel: 18,
    levelRequirementPerRank: [18, 21, 23, 25],
    flavor: "The best hunters bleed with their prey.",
  },
  {
    id: "ss_deadeye_passive", charClass: "ranger", path: "sharpshooter",
    name: "Deadeye Instinct",
    description: "Heightened senses sharpen your aim past the point of reason. A massive Agility buff that lasts long enough to define an entire fight.",
    kind: "active_buff",
    maxRank: 3,
    rankCosts: [3, 3, 4],
    baseManaCost: 22, manaCostPerRank: 4,
    ...
    effect: {
      kind: "buff_stat",
      baseMagnitude: 35, magnitudePerRank: 15,
      duration: 4,
      buffKind: "buff_agi",
    },
    requires: ["ss_triple_shot"],
    position: { tier: 3, col: 1 },
    minLevel: 20,
    levelRequirementPerRank: [20, 23, 26],
    flavor: "Time does not slow. You simply move through it faster.",
  },
  {
    id: "ss_kill_shot", charClass: "ranger", path: "sharpshooter",
    name: "Kill Shot",
    description: "One shot held in reserve all run — an arrow drawn from a place beyond anger. Costs 15 HP. Devastates a single target. Once per dungeon.",
    kind: "active_attack",
    maxRank: 1,
    rankCosts: [4],
    baseManaCost: 28, manaCostPerRank: 0,
    cooldown: 0,
    effect: {
      kind: "damage",
      baseMagnitude: 4.5, magnitudePerRank: 0,
      scaling: { stat: "agi", basePct: 450, pctPerRank: 0 },
      selfDamage: 15,
      refundCdOnKill: false,
    },
    requires: ["ss_predator"],
    position: { tier: 3, col: 2 },
    minLevel: 22,
    levelRequirementPerRank: [22],
    oncePerRun: true,
    flavor: "Every ranger keeps one arrow that has a name on it.",
  },

  // ===================== RANGER — SHADOWBOW PATH =====================
  // Sustained, evasive, lifesteal-based. Pairs with VIT / lifesteal gear.
  // Survives the long fight by stealing life back with every hit.
  {
    id: "sb_shadow_arrow", charClass: "ranger", path: "shadowbow",
    name: "Shadow Arrow",
    description: "An arrow coated in a dark tincture that turns the target's vitality into yours — every hit heals a portion of what it deals.",
    kind: "active_attack",
    maxRank: 5,
    rankCosts: [2, 2, 3, 3, 4],
    baseManaCost: 10, manaCostPerRank: 2,
    ...
    effect: {
      kind: "damage",
      baseMagnitude: 1.4, magnitudePerRank: 0.25,
      scaling: { stat: "agi", basePct: 140, pctPerRank: 25 },
      bonusLifestealPct: 25,
    },
    requires: [],
    position: { tier: 1, col: 1 },
    minLevel: 15,
    levelRequirementPerRank: [15, 17, 19, 21, 23],
    flavor: "Take only what you need. Take all of it.",
  },
  {
    id: "sb_phase_step", charClass: "ranger", path: "shadowbow",
    name: "Phase Step",
    description: "Ghost-step sideways through a heartbeat of unreality. The shield snaps into place before you land, absorbing the blow that would have killed you.",
    kind: "active_buff",
    maxRank: 4,
    rankCosts: [2, 2, 3, 3],
    baseManaCost: 14, manaCostPerRank: 2,
    ...
    effect: {
      kind: "shield",
      baseMagnitude: 65, magnitudePerRank: 30,
      duration: 99,
    },
    requires: [],
    position: { tier: 1, col: 2 },
    minLevel: 15,
    levelRequirementPerRank: [15, 17, 20, 23],
    flavor: "The dodge is only remarkable to the thing that missed.",
  },
  {
    id: "sb_venom_shot", charClass: "ranger", path: "shadowbow",
    name: "Venom Shot",
    description: "AGI and VIT both feed this attack — the arrow's mass and your steady hands multiply its killing potential. Reliable, mean, and tactically flexible.",
    kind: "active_attack",
    maxRank: 4,
    rankCosts: [2, 3, 3, 4],
    baseManaCost: 16, manaCostPerRank: 3,
    ...
    effect: {
      ...
      baseMagnitude: 1.8, magnitudePerRank: 0.3,
      scaling: { stat: "agi", basePct: 180, pctPerRank: 30 },
      secondaryScaling: { stat: "vit", basePct: 60, pctPerRank: 15 },
    },
    requires: ["sb_shadow_arrow"],
    position: { tier: 2, col: 1 },
    minLevel: 18,
    levelRequirementPerRank: [18, 20, 22, 24],
    flavor: "A stronger body makes a deadlier arrow. The rangers figured this out ages ago.",
  },
  {
    id: "sb_dark_quiver", charClass: "ranger", path: "shadowbow",
    name: "Dark Quiver",
    description: "Draw from the black quiver — these arrows hunger. Bonus lifesteal surges on each hit, and the wound costs you a sliver of blood to open.",
    kind: "active_attack",
    maxRank: 4,
    rankCosts: [3, 3, 4, 4],
    baseManaCost: 20, manaCostPerRank: 3,
    ...
    effect: {
      ...
      baseMagnitude: 2.2, magnitudePerRank: 0.35,
      scaling: { stat: "agi", basePct: 220, pctPerRank: 35 },
      bonusLifestealPct: 40,
      selfDamage: 8,
    },
    requires: ["sb_phase_step"],
    position: { tier: 2, col: 2 },
    minLevel: 18,
    levelRequirementPerRank: [18, 21, 23, 25],
    flavor: "It hurts to draw. It hurts more not to.",
  },
  {
    id: "sb_umbral_volley", charClass: "ranger", path: "shadowbow",
    name: "Umbral Volley",
    description: "A torrent of shadow-tipped arrows that scale off both your speed and your toughness. Hits hard, heals back. The Shadowbow's signature burst.",
    kind: "active_attack",
    maxRank: 3,
    rankCosts: [3, 4, 4],
    baseManaCost: 26, manaCostPerRank: 4,
    cooldown: 4,
    effect: {
      kind: "damage",
      baseMagnitude: 3.0, magnitudePerRank: 0.5,
      scaling: { stat: "agi", basePct: 300, pctPerRank: 50 },
      secondaryScaling: { stat: "vit", basePct: 100, pctPerRank: 30 },
      bonusLifestealPct: 20,
    },
    requires: ["sb_venom_shot"],
    position: { tier: 3, col: 1 },
    minLevel: 20,
    levelRequirementPerRank: [20, 23, 26],
    flavor: "The dark does not tire. Neither do you.",
  },
  {
    id: "sb_final_breath", charClass: "ranger", path: "shadowbow",
    name: "Final Breath",
    description: "Once per run — a still-point of absolute focus. The arrow leaves without sound. What it takes from the enemy, it gives entirely back to you.",
    kind: "active_attack",
    maxRank: 1,
    rankCosts: [4],
    baseManaCost: 24, manaCostPerRank: 0,
    ...
    effect: {
      kind: "damage",
      baseMagnitude: 3.5, magnitudePerRank: 0,
      scaling: { stat: "agi", basePct: 350, pctPerRank: 0 },
      bonusLifestealPct: 60,
    },
    requires: ["sb_dark_quiver"],
    position: { tier: 3, col: 2 },
    minLevel: 22,
    levelRequirementPerRank: [22],
    oncePerRun: true,
    flavor: "In the quiet between heartbeats, you are something other than mortal.",
  },

  // ===================== SORCERER — PYROMANCER PATH =====================
  // Pure INT destruction. Fire gear doubles the carnage. Pay HP for power.
  {
    id: "py_flame_bolt", charClass: "sorcerer", path: "pyromancer",
    name: "Flame Bolt",
    description: "A shard of compressed combustion hurled at the target's center of mass. Burns hotter than Arcane Bolt and scales upward with every rank.",
    kind: "active_attack",
    maxRank: 5,
    rankCosts: [2, 2, 3, 3, 4],
    baseManaCost: 14, manaCostPerRank: 2,
    ...
    effect: {
      kind: "damage",
      baseMagnitude: 2.0, magnitudePerRank: 0.35,
      scaling: { stat: "int", basePct: 200, pctPerRank: 35 },
    },
    requires: [],
    position: { tier: 1, col: 1 },
    minLevel: 15,
    levelRequirementPerRank: [15, 17, 19, 21, 23],
    flavor: "First the warmth. Then the reckoning.",
  },
  {
    id: "py_mana_burn", charClass: "sorcerer", path: "pyromancer",
    name: "Mana Burn",
    description: "You bypass the mana system entirely — instead, you write the spell in blood. No mana cost, but 14 HP leaves your body as fuel.",
    kind: "active_attack",
    maxRank: 4,
    rankCosts: [2, 3, 3, 4],
    baseManaCost: 0, manaCostPerRank: 0,
    ...
    effect: {
      kind: "damage",
      baseMagnitude: 2.2, magnitudePerRank: 0.4,
      scaling: { stat: "int", basePct: 220, pctPerRank: 40 },
      selfDamage: 14,
    },
    requires: [],
    position: { tier: 1, col: 2 },
    minLevel: 15,
    levelRequirementPerRank: [15, 18, 21, 24],
    flavor: "Mana is a courtesy. You have stopped being courteous.",
  },
  {
    id: "py_inferno", charClass: "sorcerer", path: "pyromancer",
    name: "Inferno",
    description: "The word for 'targeted' and the word for 'entire environment' are the same, at sufficient power. A massive fire-class detonation.",
    kind: "active_attack",
    maxRank: 3,
    rankCosts: [3, 3, 4],
    baseManaCost: 30, manaCostPerRank: 5,
    cooldown: 4,
    effect: {
      kind: "damage",
      baseMagnitude: 3.2, magnitudePerRank: 0.6,
      scaling: { stat: "int", basePct: 320, pctPerRank: 60 },
    },
    requires: ["py_flame_bolt"],
    position: { tier: 2, col: 1 },
    minLevel: 18,
    levelRequirementPerRank: [18, 21, 24],
    flavor: "The ground where this lands is a different material afterwards.",
  },
  {
    id: "py_arcane_surge", charClass: "sorcerer", path: "pyromancer",
    name: "Arcane Surge",
    description: "Force your intellect past every natural limit. +INT for four turns — every spell cast in that window hits with compounding devastation.",
    kind: "active_buff",
    maxRank: 3,
    rankCosts: [2, 3, 3],
    baseManaCost: 16, manaCostPerRank: 3,
    ...
    effect: {
      kind: "buff_stat",
      baseMagnitude: 28, magnitudePerRank: 14,
      duration: 4,
      buffKind: "buff_int",
    },
    requires: ["py_mana_burn"],
    position: { tier: 2, col: 2 },
    minLevel: 18,
    levelRequirementPerRank: [18, 21, 24],
    flavor: "The ceiling was always a suggestion.",
  },
  {
    id: "py_firestorm", charClass: "sorcerer", path: "pyromancer",
    name: "Firestorm",
    description: "An expanding gyre of plasma that answers only to you — barely. The most sustained INT damage in the tree, with a painful HP tax for casting it.",
    kind: "active_attack",
    maxRank: 3,
    rankCosts: [3, 4, 4],
    baseManaCost: 28, manaCostPerRank: 4,
    ...
    effect: {
      kind: "damage",
      baseMagnitude: 3.8, magnitudePerRank: 0.6,
      scaling: { stat: "int", basePct: 380, pctPerRank: 60 },
      selfDamage: 18,
    },
    requires: ["py_inferno"],
    position: { tier: 3, col: 1 },
    minLevel: 20,
    levelRequirementPerRank: [20, 23, 26],
    flavor: "Some forces are not controlled. They are negotiated with.",
  },
  {
    id: "py_void_cataclysm", charClass: "sorcerer", path: "pyromancer",
    name: "Void Cataclysm",
    description: "You reach past the veil of reality and pull something terrible through it. Once per run. Costs 20% of your max HP. Destroys everything in front of you.",
    kind: "active_attack",
    maxRank: 1,
    rankCosts: [5],
    baseManaCost: 35, manaCostPerRank: 0,
    cooldown: 0,
    effect: {
      kind: "damage",
      baseMagnitude: 5.5, magnitudePerRank: 0,
      scaling: { stat: "int", basePct: 550, pctPerRank: 0 },
      selfDamagePctMaxHp: 0.20,
    },
    requires: ["py_arcane_surge"],
    position: { tier: 3, col: 2 },
    minLevel: 22,
    levelRequirementPerRank: [22],
    oncePerRun: true,
    flavor: "There is a reason the Sorcerers before you stopped teaching this one.",
  },

  // ===================== SORCERER — SAGE PATH =====================
  // Sustain, defense, INT+VIT synergy. Outlast the enemy. Once-per-run insurance.
  {
    id: "sg_mana_strike", charClass: "sorcerer", path: "sage",
    name: "Mana Strike",
    description: "A measured pulse of arcane force that scales off both INT and VIT — the Sage's way of saying 'I can take a hit and still hit back.'",
    kind: "active_attack",
    maxRank: 5,
    rankCosts: [2, 2, 3, 3, 4],
    baseManaCost: 12, manaCostPerRank: 2,
    ...
    effect: {
      kind: "damage",
      baseMagnitude: 1.5, magnitudePerRank: 0.25,
      scaling: { stat: "int", basePct: 150, pctPerRank: 25 },
      secondaryScaling: { stat: "vit", basePct: 60, pctPerRank: 15 },
    },
    requires: [],
    ...
    minLevel: 15,
    levelRequirementPerRank: [15, 17, 19, 21, 23],
    flavor: "The oldest magical disciplines were not spells. They were principles.",
  },
  {
    id: "sg_arcane_mend", charClass: "sorcerer", path: "sage",
    name: "Arcane Mend",
    description: "A structured healing current drawn from your own mana pool — restores a meaningful fraction of max HP and keeps you fighting.",
    kind: "active_heal",
    maxRank: 4,
    rankCosts: [2, 2, 3, 3],
    baseManaCost: 18, manaCostPerRank: 3,
    ...
    effect: {
      kind: "heal",
      baseMagnitude: 0.22, magnitudePerRank: 0.06,
    },
    requires: [],
    position: { tier: 1, col: 2 },
    minLevel: 15,
    levelRequirementPerRank: [15, 17, 19, 21],
    flavor: "The body is a library. You know all the right passages.",
  },
  {
    id: "sg_runic_ward", charClass: "sorcerer", path: "sage",
    name: "Runic Ward",
    description: "Layers a runic shield over your body — and as the last glyph sets, a pulse of restorative magic heals a portion of your max HP as well.",
    kind: "active_buff",
    maxRank: 3,
    rankCosts: [2, 3, 3],
    baseManaCost: 20, manaCostPerRank: 4,
    cooldown: 3,
    effect: {
      kind: "shield",
      baseMagnitude: 90, magnitudePerRank: 40,
      duration: 99,
      bonusHealPctMaxHp: 0.08,
    },
    requires: ["sg_arcane_mend"],
    position: { tier: 2, col: 1 },
    minLevel: 18,
    levelRequirementPerRank: [18, 21, 24],
    flavor: "To hold fast is itself a kind of power.",
  },
  {
    id: "sg_ley_conduit", charClass: "sorcerer", path: "sage",
    name: "Ley Conduit",
    description: "Tap into a buried ley line and channel its raw INT into you — a surging, long-lasting Intellect buff that elevates every spell you cast.",
    kind: "active_buff",
    maxRank: 3,
    rankCosts: [2, 3, 3],
    baseManaCost: 18, manaCostPerRank: 3,
    ...
    effect: {
      kind: "buff_stat",
      baseMagnitude: 22, magnitudePerRank: 11,
      duration: 5,
      buffKind: "buff_int",
    },
    requires: ["sg_mana_strike"],
    position: { tier: 2, col: 2 },
    minLevel: 18,
    levelRequirementPerRank: [18, 21, 24],
    flavor: "There is more magic in the ground than in the sky. The Sages always knew.",
  },
  {
    id: "sg_deep_mend", charClass: "sorcerer", path: "sage",
    name: "Deep Mend",
    description: "A prolonged weaving of healing magic on a scale that dwarfs Arcane Mend. Takes concentration — and mana — but restores a massive fraction of your HP.",
    kind: "active_heal",
    maxRank: 3,
    rankCosts: [3, 3, 4],
    baseManaCost: 30, manaCostPerRank: 5,
    ...
    effect: {
      kind: "heal",
      baseMagnitude: 0.45, magnitudePerRank: 0.12,
    },
    requires: ["sg_runic_ward"],
    position: { tier: 3, col: 1 },
    minLevel: 20,
    levelRequirementPerRank: [20, 23, 26],
    flavor: "You are not losing. You are postponing.",
  },
  {
    id: "sg_fateweave", charClass: "sorcerer", path: "sage",
    name: "Fateweave",
    description: "You rewrite the moment of your death. Once per run — the next lethal blow finds you still breathing, body held at 1 HP by a lattice of impossible will.",
    kind: "active_buff",
    maxRank: 1,
    rankCosts: [4],
    baseManaCost: 28, manaCostPerRank: 0,
    ...
    requires: ["sg_ley_conduit"],
    position: { tier: 3, col: 2 },
    minLevel: 22,
    levelRequirementPerRank: [22],
    oncePerRun: true,
    flavor: "Death is a pattern. Patterns can be unraveled.",
  },
];
...
export const PATHS: PathDef[] = [
  ...
  // ===================== RANGER PATHS =====================
  {
    id: "sharpshooter",
    charClass: "ranger",
    name: "Path of the Sharpshooter",
    tagline: "One breath. One shot. One kill.",
    description:
      "Every arrow is a decision. The Sharpshooter makes each decision count — building crit windows, burning their own HP for catastrophic shots, and closing fights before they become wars of attrition.",
    identity: "Precision · Burst · Glass Cannon",
    strengths: [
      "Highest single-target AGI damage in the Ranger tree.",
      "Eagle's Eye + Deadeye Instinct create devastating crit windows.",
      "Kill Shot closes bosses instantly when timed right.",
    ],
    weaknesses: [
      "No sustain — Predator's Mark and Kill Shot drain your own HP.",
      "Very fragile: one bad roll without a shield means death.",
      "Relies on high-AGI gear and precise rotation to shine.",
    ],
    color: "#16a34a",
  },
  {
    id: "shadowbow",
    charClass: "ranger",
    name: "Path of the Shadowbow",
    tagline: "Strike from where the light doesn't reach.",
    description:
      "The Shadowbow turns every wound they deal into a meal. Dark arrows, phase-shifts, and compounding lifesteal make them nearly unkillable in long fights — but they need time to build the tempo.",
    identity: "Evasive · Sustained · Lifesteal",
    strengths: [
      "Shadow Arrow and Dark Quiver sustain you through prolonged fights.",
      "Phase Step + Umbral Volley provides strong burst alongside survivability.",
      "VIT secondary scaling rewards tanky gear on an agility class.",
    ],
    weaknesses: [
      "Lower burst ceiling than Sharpshooter — fights take longer.",
      "Dark Quiver's HP cost stacks with enemy hits in unfavorable trades.",
      "Final Breath is powerful but consumes the only once-per-run slot.",
    ],
    color: "#7c3aed",
  },
  // ===================== SORCERER PATHS =====================
  {
    ...
    tagline: "The world is fuel. All of it.",
    description:
      "The Pyromancer has stopped asking permission from their own body. Mana Burn bypasses the mana economy entirely. Void Cataclysm rewrites a fight in one cast. Fire-affixed gear doubles the carnage. The cost is flesh.",
    identity: "Explosive · Destructive · High Risk",
    strengths: [
      "Highest INT burst damage in the game — Void Cataclysm can one-shot bosses.",
      "Fire-affixed gear is doubly effective due to Inferno and Firestorm.",
      "Arcane Surge + Inferno creates a catastrophic power window.",
    ],
    weaknesses: [
      "Mana Burn and Firestorm cost HP — chip damage compounds dangerously.",
      "Void Cataclysm costs 20% max HP and is only usable once per run.",
      "No healing whatsoever — must kill fast or die trying.",
    ],
    color: "#ea580c",
  },
  {
    ...
    tagline: "The mind that survives the storm grows stronger for it.",
    description:
      "The Sage does not burn bridges — they build walls. Runic Ward, Deep Mend, and Ley Conduit turn the Sorcerer into a sustained fighter who outlasts every enemy they face. Fateweave ensures they get the chance to.",
    identity: "Sustained · Defensive · Healing",
    strengths: [
      "Runic Ward provides shield + heal in a single cast.",
      "Deep Mend restores nearly half max HP — the best healing in any class.",
      "Fateweave is a once-per-run cheat death, the Sage's ultimate insurance.",
    ],
    weaknesses: [
      "Significantly lower damage output than the Pyromancer.",
      "Mana-hungry: Deep Mend and Runic Ward drain the mana bar quickly.",
      "Fights last longer — dangerous dungeons punish slow kills.",
    ],
    color: "#0ea5e9",
  },
];
